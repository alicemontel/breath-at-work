function showDay(day){
	...
	switch(day){
		...
		case "19" : 
			...
			"lorsque vous êtes concentré·e· sur les tâches quotidiennes. Niveau santé, une étude menée en 2015 a montré que les personnes travaillant trop augmentent leur risque de faire une crise cardiaque. "+
			...
			break;
		case "20" : 
			content="Nous vous proposons aujourd\'hui une astuce pour vous aider à vous organiser "+
		...
		case "23" : 
			content="<img id=\"list\" src=\"./img/checklist_pixabay.png\"/>"+
			"Revenons aujourd\'hui dans le monde fabuleux des todo list, pour une todo list efficace qui nous aidera à bien terminer la semaine et profiter des fêtes sans penser au boulot !<br/><br/>"+
			...
			"<li> Si vous n\'avez pas fini à l\'heure limite, disons 18h30 grand maximum, tant pis. Notez dans un coin là où vous en êtes et fermez tout. Vous saurez pour la prochaine fois que certaines choses prennent plus de temps qu\'il n\'y parait.</li>"+
			...
			"Aller chercher le pain, commander les croquettes pour le chat, passer la serpillère dans la cuisine, imperméabiliser les chaussures, ... tout y passe !<br/>"+ 
