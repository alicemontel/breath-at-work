	...
	switch(day){
		case "1" :
			content="La bienveillance en entreprise, ça vous parle ?<br/><br/>" + 
				"Pour commencer en douceur, je vous propose un petit exercice inspiré du livre \"Les 10 commandements de la bienveillance en entreprise\", de Gaël Chatelain-Berry"+ 
				" (je vous invite grandement à faire un tour sur <a target=\"blank\" href=\"https://www.gchatelain.com/\">son site</a>, une mine d'or !).<br/>"+
				...
				"</ol>"+
				"Maintenant, je vais vous demander, pour chaque critère, de déterminer des actions à mettre en place pour améliorer votre score."+
		...
		case "8" : 
			...
			break;
		case "9" : 
			content="<img id=\"breathe\" src=\"./img/yoga_clkerfreevectorimages_pixabay.png\"/>Hier, nous avons ciblé la productivité alors aujourd\'hui, je vous propose de travailler sur vous, votre concentration et votre gestion du stress "+
			"(en soi, cela peut aussi avoir un impact positif sur votre productivité mais ce n\'est pas l\'objectif premier de la démarche).<br/><br/>"+
			"Je vais vous exposer un (parmi tant !) <b>exercice de respiration</b> que je trouve particulièrement efficace. Et selon votre récéptivité à ce genre d'exercices, vous pourrez creuser, ou non. <br/>"+
			...
			"C\'est parti ! <br/> "+
			"Je vais présenter l\'exercice en étant droitière, si vous êtes gaucher·e, vous pouvez inverser les mains.<br/>"+
		...
		case "13" : 
			...
			break;
		case "14" : 
			content="<img id=\"cat\" src=\"./img/kitten_ReSampled_pixabay.png\"/>Vous l\'entendez probablement souvent, surtout en cette période si particulière où le télétravail contraint et durable est majoritaire : "+
